  ...
  return (
    <>
      ...
      <style>{`
        ...
        .nav-container { max-width: 1200px; margin: 0 auto; display: flex; align-items: center; justify-content: space-between; padding: 0.75rem 1rem; }
        .nav-links { display: flex; gap: 1.5rem; font-weight: 600; }
        .hamburger { font-size: 1.5rem; background: transparent; border: none; cursor: pointer; display: none; }
        ...
        /* Hero */
        .hero { min-height: 60vh; display:flex; flex-direction:column; align-items:center; justify-content:center; text-align:center; color:var(--text-light); background:url(${heroBg}) center/cover no-repeat; position:relative; }
        ...
        .btn-primary { display:inline-block; padding:.75rem 1.75rem; border-radius:.375rem; font-weight:600; color:var(--text-light); background:var(--primary); transition:background .2s ease; }
        ...
        <>
          ...
          <aside className={`drawer ${menuOpen ? 'open' : ''}`}>
            <button
              ...
              style={{ background: 'transparent', border: 'none', fontSize: '1.5rem', position: 'absolute', top: '1rem', right: '1rem', cursor: 'pointer' }}
            >
              ×
            </button>
            <nav>
